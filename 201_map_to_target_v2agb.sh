...
FQ_DIR="/tarafs/data/home/hrasoara/proj5034-AGBKU/genome_chicken/trimmed"
mkdir "data/raw_sam_v2agb"
for genome in "${genomes[@]}"
do
  echo "${genome}"
  bwa mem -t 120 \
    "data/fasta_seqs/target.fa" \
    "${FQ_DIR}/${genome}_1_pairend_trimmed.fq" \
    "${FQ_DIR}/${genome}_2_pairend_trimmed" \
    > "data/raw_sam_v2agb"
done